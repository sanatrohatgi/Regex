...
public class regex extends javax.swing.JFrame {
    ...
    public regex() {
        initComponents();
        A = new String[2];  //The String and the Regex Expression 
    }
    ...
    private void initComponents() {
        ...
        jTextField3.setText("                               REGULAR EXPRESSIONS");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        A[0] = jTextField2.getText();  //Regex
        A[1] = jTextField1.getText();  //String
        t = check();
        if (t == true) {
    ...
    boolean check() {               //Method to check the i/p
        return A[1].matches(A[0]);
    }
